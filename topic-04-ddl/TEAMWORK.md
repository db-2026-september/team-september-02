...
|---|---|---|---|
|Vitaliy Fronts|SQL Developer|Реалізація DDL для блоку локацій, складського обліку та постачальників (`locations`, `location_inventory`, `suppliers`, `supplier_ingredients`)|`ddl.sql` (секція: Локації та склад)|
